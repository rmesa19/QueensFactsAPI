...
import { MapPin, Info, RefreshCw, Globe, Home, Film, Twitter, Instagram, Facebook, Loader } from "lucide-react"
import { Button } from "@/components/ui/button"

export default function QueensFactsPage() {
  const [currentFact, setCurrentFact] = useState<string>("Loading your first Queens fact...")
  ...
  return (
    <div className={`min-h-screen bg-gray-50 transition-all duration-500 ${isDarkMode ? "dark" : ""}`}>
      {/* Custom styles for Queens theme */}
      <style jsx global>{`
        ...
        <div className="container mx-auto px-4 pt-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-lg mt-2">Discover the most diverse place on Earth</p>
            </div>
            <div className="hidden md:block">
              <img src="/queens-nyc-skyline-cityscape.jpg" alt="Queens skyline" className="h-20 rounded-lg shadow-lg" />
            </div>
          </div>
          <div className="mt-12 text-center">
            <div className="inline-block bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-1">
              ...
              <span className="ml-2 font-medium">Queens, New York</span>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 md:p-10 fact-card">
            <div className="text-center">
              <Info className="text-blue-600 w-12 h-12 mx-auto" />
              <div className="mt-6">
                <p className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-gray-100">{currentFact}</p>
              </div>
              <Button
                onClick={handleNewFact}
                disabled={isLoading}
                className="queens-gradient text-white font-bold py-3 px-8 rounded-full mt-8 hover:opacity-90 transition-all duration-300 shadow-lg pulse"
              >
                {isLoading ? (
                  <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Over 130 languages are spoken in Queens, making it the most ethnically diverse urban area in the world.
              </p>
            </div>
            <div className="bg-yellow-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                From Astoria to Flushing, each neighborhood offers unique cultural experiences and cuisines.
              </p>
            </div>
            <div className="bg-red-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Kaufman Astoria Studios has been home to productions from Sesame Street to Orange is the New Black.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="mt-2 text-gray-400">Discovering the borough that never sleeps (as much as Manhattan)</p>
            </div>
